      ...
      <div className="gantt__controls">
        ...
        <div className="gantt__actions">
          ...
          <div className="gantt__select-group">
            ...
            <button type="button" onClick={() => selectedTask && openEdit(selectedTask)} disabled={!selectedTask}>
              Edit
            </button>
            <button
              type="button"
          ...
          <button type="button" className="gantt__primary" onClick={openCreate} disabled={projects.length === 0}>
            New task
          </button>
        </div>
      </div>
