...
const AccountBanner = ({ user, onUpdateProfile, onSignOut, onStartTutorial }: AccountBannerProps) => {
    ...
    <header className="topbar">
      <div className="topbar__main">
        ...
        <div className="topbar__actions">
          {onStartTutorial && (
            <button type="button" className="topbar__button" onClick={onStartTutorial}>
              Take a tour
            </button>
          )}
          <button
